...
if (isset($_GET['rasa']))
  {
    ...
    $smarty->assign(array("Raceinfo" => $strRaceinfo,
			  ...
			  "Tstats" => array('do siły, maksymalna wartość cechy:', 'do zręczności, maksymalna wartość cechy:', 'do kondycji, maksymalna wartość cechy:', 'do szybkości, maksymalna wartość cechy:', 'do inteligencji, maksymalna wartość cechy:', 'do siły woli, maksymalna wartość cechy:'),
			  "Aback" => "Wróć",
			  "Aselect" => "Wybierz"));
  }
else 

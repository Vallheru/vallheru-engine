			 ...
			 if ($objOfert->fields['type'] != 'R')
			 ...
			 else
			   {
			     ...
			     $intAmount = $objAmount -> fields['wt'];
                    ...
                    if ($intKey == 2)
                    {
                        $objAmount = $db -> Execute("SELECT `id`, `amount` FROM `potions` WHERE `owner`=".$player -> id." AND `name`='".$objOfert -> fields['name']."' AND `efect`='".$objOfert -> fields['efect']."' AND `type`='".$objOfert -> fields['type']."'");
                        $intAmount = $objAmount -> fields['amount'];
                    }
                    if ($intKey == 3)
                    {

...
{
    define("TEMPLE_INFO", "Wkraczasz do Świętego kasztanowca... Uderza Cię tajemnicza aura boskości panująca w tym miejscu. W każdym z rogów pomieszczenia stoi posąg każdego z Bóstw. Podchodzi do Ciebie nieznana postać z kapturem. Domyślasz się, ze jest to kapłan opiekujący się Świątynią...<br /><i>- Witaj w tym świętym przybytku. Jeśli chcesz się pomodlić i uzyskać błogosławieństwo musisz najpierw popracować aby zyskać przychylność Bogów i zdobyć ich czas. Gdy już to uczynisz to możesz próbować  zdobyć błogosławieństwo.</i>");
}

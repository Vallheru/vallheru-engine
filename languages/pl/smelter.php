...
define("SMELTER_INFO", "Witaj w hucie. Tutaj możesz wytapiać różne minerały oraz przetapiać przedmioty.");
...
if (isset($_GET['step']))
  {
	...
	define("A_UPGRADE3", "Ulepsz");
	define("NO_MONEY", "Nie masz tyle sztuk złota!");
	define("YOU_UPGRADE", "Rozbudowałeś swoją hutę.");
      }

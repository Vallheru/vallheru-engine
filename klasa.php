...
if (isset($_GET['klasa']))
  {
    ...
    $smarty->assign(array("Classinfo" => $strClass,
			  "Tstats" => array('do siły', 'do zręczności', 'do kondycji', 'do szybkości', 'do inteligencji', 'do siły woli'),
			  "Stats" => $arrStats));
  }
else
  {

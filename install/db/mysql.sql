...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `max_energy` double(11,2) NOT NULL DEFAULT '100.00',
  ...
  `antidote` CHAR(4) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `stats` VARCHAR( 2048 ) NOT NULL DEFAULT 'strength:Siła,0,0,0;agility:Zręczność,0,0,0;condition:Kondycja,0,0,0;speed:Szybkość,0,0,0;inteli:Inteligencja,0,0,0;wisdom:Siła Woli,0,0,0;',
  ...
  `rinvite` INT( 11 ) NOT NULL DEFAULT '0',
  `tinvite` INT( 11 ) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `tribes` (
  ...
  `traps` TINYINT( 3 ) NOT NULL DEFAULT '0',
  `agents` TINYINT( 3 ) NOT NULL DEFAULT '0',
  `dagents` TINYINT( 3 ) NOT NULL DEFAULT '0',
  UNIQUE KEY `id` (`id`),
  KEY `level` (`level`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

...
{
    $arrRank = array('Member', 'Admin', 'Staff', 'Sędzia', 'Ławnik', 'Prawnik', 'Żebrak', 'Barbarzyńca', 'Bibliotekarz', 'Rycerz', 'Dama', 'Marszałek Rady', 'Poseł', 'Kanclerz Sądu', 'Królewski Błazen', 'Redaktor', 'Karczmarka','Bohater', 'Prokurator');
    if ($strGender != 'F')
    {
        $arrRank2 = array(R_MEMBER, R_KING, R_STAFF, R_JUDGE, R_JUDGE2, R_LAWYER, R_BEGGAR, R_BARBARIAN, R_SCRIBE, R_KNIGHT, R_LADY, R_COUNT, R_COUNT2, R_JUDGE3, R_JOKER, R_REDACTOR, R_INNKEEPER, R_HERO, R_PROCURATOR);
    }
        else
    {

...
{/if}
            <tr>
                ...
                <td align="center">
                    <span class="light">
                    &copy; 2004-2006 <a href="http://vallheru.sourceforge.net/">Vallheru Team</a> based on <a href="http://sourceforge.net/projects/gamers-fusion">Gamers-Fusion 2.5</a></span>
                </td>
                {if $Stephead != "new"}
                <td class="foot">
                </td>

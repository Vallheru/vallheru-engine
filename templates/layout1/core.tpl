...
{if $View == "best"}
    ...
    <tr>
    <td width="200">
        <table class="dark" width="100%" cellpadding="0" cellspacing="0">
...
{if $View == "mycores"}
    ...
    {/if}
    {if $Coreid > "0"}
        <center><br /><table class="dark" width="300" cellpadding="0" cellspacing="0">
        <tr><td align="center" colspan="2"><b>{$Showcore}</b></td></tr>
        ...
        <tr><td colspan="2" align="center">{$Coptions}:
...
{if $View == "library"}
    ...
    {if $Coreid > "0"}
        {if $Yourcore > 0}
        <br /><center>
        <table cellpadding="0" cellspacing="0" class="dark" align="center" width="300">
        <tr><td colspan="2" align="center"><b>{$Showcore}</b></td></tr>
...
{if $View == "arena"}
    ...
    {if $Step == "battles" && $Attack == ""}
        <table class="dark"><tr><td width=100><b><u>{$Tcore}</u></b></td><td width=100><b><u>{$TOwner}</u></b></td><td width=100><b><u>{$Coptions}</u></b></td></tr>

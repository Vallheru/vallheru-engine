...
{if $View == "make"}
    <table class="dark"><form method="post" action="tribes.php?view=make&amp;step=make">
...
{if $View == "my"}
    ...
    {if $Step == "zielnik"}
        ...
        {if $Step2 == "daj"}
            {$Addherb}<br /><br />
            <form method="post" action="tribes.php?view=my&amp;step=zielnik&amp;step2=daj&amp;step3=add"><table class="dark">
    ...
    {if $Step == "owner"}
        ...
        {/if}
        {if $Step2 == "messages"}
            <form method="post" action="tribes.php?view=my&amp;step=owner&amp;step2=messages&amp;action=edit"><table class="dark">

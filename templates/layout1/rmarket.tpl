...
{if $View == "market"}
    {$Viewinfo} <a href="rmarket.php">{$Aback}</a>.<br />
    ...
    <table class="dark">
    <tr>
    <td width="100"><a href="rmarket.php?view=market&amp;lista=name&amp;order={$Aorder2}"><b><u>{$Tname}</u></b></a></td>
    <td width="100"><a href="rmarket.php?view=market&amp;lista=power&amp;order={$Aorder2}"><b><u>{$Tpower}</u></b></a></td>
    <td width="50"><a href="rmarket.php?view=market&amp;lista=minlev&amp;order={$Aorder2}"><b><u>{$Tlevel}</u></b></a></td>
    <td width="50"><a href="rmarket.php?view=market&amp;lista=amount&amp;order={$Aorder2}"><b><u>{$Tamount}</u></b></a></td>
    <td width="100"><a href="rmarket.php?view=market&amp;lista=cost&amp;order={$Aorder2}"><b><u>{$Tcost}</u></b></a></td>
    <td width="50"><a href="rmarket.php?view=market&amp;lista=owner&amp;order={$Aorder2}"><b><u>{$Tseller}</u></b></a></td>
    ...
    {if $Tpages > 1}
	    ...
	    {if $page == $Tpage}
	        {$page}
	    {else}
                <a href="rmarket.php?view=market&page={$page}&amp;lista={$Mlist}&amp;order={$Aorder}">{$page}</a>
	    {/if}
    	{/for}
    {/if}
{/if}
...
{if $View == "add"}
    ...
    <form method="post" action="rmarket.php?view=add&amp;step=add"><table class="dark">
    <tr><td colspan="2">
...
{if $Buy != ""}
    ...
    <form method="post" action="rmarket.php?buy={$Itemid}&amp;step=buy"><table class="dark">

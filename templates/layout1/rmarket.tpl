...
{if $View == "szukaj"}
    {$Sinfo} <a href="rmarket.php">{$Aback}</a>{$Sinfo2}<br /><br />
    <form method="post" action="rmarket.php?view=market&amp;limit=0&amp;lista=name"><table class="dark">
...
{if $View == "market"}
    ...
    <table class="dark">
    <tr>
    <td width="100"><a href="rmarket.php?view=market&amp;lista=name&amp;limit=0"><b><u>{$Tname}</u></b></a></td>
    <td width="100"><a href="rmarket.php?view=market&amp;lista=power&amp;limit=0"><b><u>{$Tpower}</u></b></a></td>
    <td width="50"><a href="rmarket.php?view=market&amp;lista=minlev&amp;limit=0"><b><u>{$Tlevel}</u></b></a></td>
    <td width="50"><a href="rmarket.php?view=market&amp;lista=amount&amp;limit=0"><b><u>{$Tamount}</u></b></a></td>
    <td width="100"><a href="rmarket.php?view=market&amp;lista=cost&amp;limit=0"><b><u>{$Tcost}</u></b></a></td>
    <td width="50"><a href="rmarket.php?view=market&amp;lista=owner&amp;limit=0"><b><u>{$Tseller}</u></b></a></td>
